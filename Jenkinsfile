pipeline {
    ...
    stages {
        ...
        stage('docker build') {
            ...
            steps {
                echo "⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️build image harbor.zetyun.cn/dingostack/dingo-command:${IMAGE_TAG}"
        ...
        stage('Pull and Tag Images') {
            ...
            steps {
                echo '⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️podman push to second registry'
        ...
        stage('Deploy to test'){
            ...
            parallel {
                ...
                stage('pull image') {
                    ...
                    steps {
                        echo "⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️++pull dingo-command images to dev cluster(56.4)"
                ...
                stage('pull image on integration test cluster(56.7)') {
                    ...
                    steps {
                        echo "⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️pull dingo-command images to integration test（56.7）"
                        // dir('/home/cicd/kolla-ansible/tools') {
