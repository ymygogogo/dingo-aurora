...
def upgrade() -> None:
    ...
    cluster_info_table = op.create_table(
        ...
        sa.Column("status_msg", sa.TEXT(), nullable=True, comment='状态信息'),
    ...
    task_info_table = op.create_table(
        ...
        sa.Column("detail", sa.TEXT(), nullable=False, default="0", comment='任务详情'),
    ...
    op.bulk_insert(cluster_params_table, [
        ...
        },
        {
            ...
            "value": "containerd,docker"
                ...
                {
            "key": "service_cidr",
            "value": "10.10.0.0/18,192.168.0.0/24"
        }
    ])
