...
def upgrade() -> None:
    ...
    sa.Column('operation_system', sa.String(length=128), nullable=True),
    ...
    sa.Column('cidr', sa.String(length=128), nullable=True),
    sa.Column('disk_type', sa.String(length=128), nullable=True),
    ...
    sa.Column('admin_address', sa.String(length=128), nullable=True),
    sa.Column('bus_address', sa.String(length=128), nullable=True),
    sa.Column('floating_ip', sa.String(length=128), nullable=True),
    ...
    sa.Column('cidr', sa.String(length=128), nullable=True),
    sa.Column('disk_type', sa.String(length=128), nullable=True),
    sa.Column('operation_system', sa.Text(), nullable=True),
    sa.Column('cpu', sa.Integer(), nullable=True),
    sa.Column('gpu', sa.Integer(), nullable=True),
    sa.Column('mem', sa.Integer(), nullable=True),
    sa.Column('disk', sa.Integer(), nullable=True),
