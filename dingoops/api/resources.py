...
@router.get("/resources/statistic_list", summary="查询所有VPC下资源统计列表", description="根据各种条件查询所有VPC下资源统计列表")
async def vpc_resource_statistic_list(page: int = Query(1, description="页码"),
...
@router.get("/resources/statistics_overview", summary="查询VPC资源统计概览视图数据", description="组装VPC资源统计概览视图数据")
