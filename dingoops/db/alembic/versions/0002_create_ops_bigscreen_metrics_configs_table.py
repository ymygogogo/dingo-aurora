<<<<<<< HEAD:dingoops/db/alembic/versions/0002_create_ops_bigscreen_metrics_configs_table.py
...
>>>>>>> b7309c3 ([feature][websocket] Add multi pod websocket function):db/alembic/versions/0002_create_ops_bigscreen_metrics_configs_table.py
